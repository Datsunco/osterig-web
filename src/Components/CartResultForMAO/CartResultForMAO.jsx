...
const CartResultForMAO = ({textbutton, disabled,isMobile}) => {
    ...
    return (
        <div className={styles.rectangleParent} style={{width: isMobile ?  '-webkit-fill-available' : '390px', height: '180px', position:'relative', bottom: isMobile ? '0': '', display: 'flex', justifyContent: isMobile ? 'center': 'flex-end', left: isMobile ? '0px': '', right: isMobile ? '10px': ''}}>
