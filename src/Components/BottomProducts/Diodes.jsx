...
const Diodes = ({isMobile}) => {
    const navigate = useNavigate()
    const { device, favorites, cart } = useContext(Context)

    return (
        <div class="PopularBody1" id="dio">
                <div class="chelka">
                    <div class="popular1" style={{fontSize: isMobile ? '14px': '20px'}}><h1>DIODES</h1></div>
                    <button class="alltovars" onClick={() => navigate("/search/319")}>
                        Все товары 
...
export default observer(Diodes);