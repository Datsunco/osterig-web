...
import styles from "./CheckBoxBlockMobile.module.css"
import { observer } from 'mobx-react-lite';
import { useContext } from 'react';
import { Context } from '../..';
// import { Context } from '../..';

const CheckBoxBlockMobile = ({ param, text}) => {
    ...
    return (
        <div className={styles.check_box_block}>
            ...
            <div className={styles.devider} style={{marginTop: '20px'}}/>
        </div>
    );
};

export default observer(CheckBoxBlockMobile);